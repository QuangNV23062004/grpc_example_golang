...
const file_coffee_shop_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\xdc\x01\n" +
...
var file_coffee_shop_proto_goTypes = []any{
	...
	(*OrderRequest)(nil), // 1: coffee_shop.OrderRequest
	(*Receipt)(nil),      // 2: coffee_shop.Receipt
	(*OrderStatus)(nil),  // 3: coffee_shop.OrderStatus
	(*MenuResponse)(nil), // 4: coffee_shop.MenuResponse
	(*Item)(nil),         // 5: coffee_shop.Item
}
var file_coffee_shop_proto_depIdxs = []int32{
	5, // 0: coffee_shop.OrderRequest.items:type_name -> coffee_shop.Item
	5, // 1: coffee_shop.MenuResponse.items:type_name -> coffee_shop.Item
	0, // 2: coffee_shop.CoffeeShopService.GetMenu:input_type -> coffee_shop.MenuRequest
	1, // 3: coffee_shop.CoffeeShopService.PlaceOrder:input_type -> coffee_shop.OrderRequest
	2, // 4: coffee_shop.CoffeeShopService.GetOrderStatus:input_type -> coffee_shop.Receipt
	4, // 5: coffee_shop.CoffeeShopService.GetMenu:output_type -> coffee_shop.MenuResponse
	2, // 6: coffee_shop.CoffeeShopService.PlaceOrder:output_type -> coffee_shop.Receipt
	3, // 7: coffee_shop.CoffeeShopService.GetOrderStatus:output_type -> coffee_shop.OrderStatus
